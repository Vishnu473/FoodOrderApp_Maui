; ModuleID = 'obj/Release/net7.0-android/android/environment.x86_64.ll'
source_filename = "obj/Release/net7.0-android/android/environment.x86_64.ll"
...
@__app_environment_variables_v_1.3 = internal constant [37 x i8] c"6d840d6c-c26f-44cf-a2a8-17d3de26b2ce\00", align 16
...
@__ApplicationConfig_android_package_name.0 = internal constant [29 x i8] c"com.companyname.foodorderapp\00", align 16
...
@application_config = local_unnamed_addr constant %struct.ApplicationConfig {
	...
	i32 100671988, ; jnienv_initialize_method_token
	i32 100671987, ; jnienv_registerjninatives_method_token
...
@__DSOCacheEntry_name.51 = internal constant [27 x i8] c"libaot-FoodOrderApp.dll.so\00", align 16
...
@dso_cache = local_unnamed_addr global [458 x %struct.DSOCacheEntry] [
	...
	; 62
	%struct.DSOCacheEntry {
		i64 2825734510150936932, ; hash 0x27370690cb1be964, from name: aot-FoodOrderApp.dll.so
		i8 0, ; ignore
		i8* getelementptr inbounds ([27 x i8], [27 x i8]* @__DSOCacheEntry_name.51, i32 0, i32 0), ; name
		i8* null; handle
	}, 
	; 63
	%struct.DSOCacheEntry {
	...
	; 124
	%struct.DSOCacheEntry {
		i64 5692414406850798881, ; hash 0x4eff84be4aa86521, from name: FoodOrderApp
		i8 0, ; ignore
		i8* getelementptr inbounds ([27 x i8], [27 x i8]* @__DSOCacheEntry_name.51, i32 0, i32 0), ; name
		i8* null; handle
	}, 
	...
	; 129
	%struct.DSOCacheEntry {
		i64 5987425758207998870, ; hash 0x53179c011d02fb96, from name: FoodOrderApp.dll.so
		i8 0, ; ignore
		i8* getelementptr inbounds ([27 x i8], [27 x i8]* @__DSOCacheEntry_name.51, i32 0, i32 0), ; name
		i8* null; handle
	}, 
	...
	; 146
	%struct.DSOCacheEntry {
		i64 6890136208350819122, ; hash 0x5f9eae6040ceb332, from name: libaot-FoodOrderApp.dll.so
		i8 0, ; ignore
		i8* getelementptr inbounds ([27 x i8], [27 x i8]* @__DSOCacheEntry_name.51, i32 0, i32 0), ; name
		i8* null; handle
	}, 
	...
	; 389
	%struct.DSOCacheEntry {
		i64 15738456655102356298, ; hash 0xda6a3af120422b4a, from name: aot-FoodOrderApp
		i8 0, ; ignore
		i8* getelementptr inbounds ([27 x i8], [27 x i8]* @__DSOCacheEntry_name.51, i32 0, i32 0), ; name
		i8* null; handle
	}, 
	...
	; 396
	%struct.DSOCacheEntry {
		i64 15933383580930714954, ; hash 0xdd1ebff2bb6aad4a, from name: libaot-FoodOrderApp
		i8 0, ; ignore
		i8* getelementptr inbounds ([27 x i8], [27 x i8]* @__DSOCacheEntry_name.51, i32 0, i32 0), ; name
		i8* null; handle
	}, 
